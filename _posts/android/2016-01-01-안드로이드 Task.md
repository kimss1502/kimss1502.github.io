 ...
 **Task란 액티비티 컬렉션을 일컫는 말로, 사용자가 특정 작업을 수행할 때 이것과 상호 작용합니다. <br> 액티비티는 스택 안에 정렬되며(BackStack), 이때 순서는 각 액티비티가 열린 순서와 같습니다.**
{: .notice}
...
### 1.1. Activity Stack
 ...
 ![task_stack](https://kimss1502.github.io/assets/images/task_stack.png)
...
### 1.2. Task 생성과 소멸
 ...
 ![task_structure](https://kimss1502.github.io/assets/images/task_structure.png)
...
> Activity의 상태를 보여달라는 명령으로 Activity에 Task 정보가 포함되어 있다. <br>
> dumpsys log 로 보는 Task 분석은 [안드로이드 Task stack 뜯어보기](https://kimss1502.github.io/%EC%95%88%EB%93%9C%EB%A1%9C%EC%9D%B4%EB%93%9C/%EC%95%88%EB%93%9C%EB%A1%9C%EC%9D%B4%EB%93%9C-Task-stack-%EB%9C%AF%EC%96%B4%EB%B3%B4%EA%B8%B0/) 포스팅을 참고할 것.
...
### 3.7. `FLAG_ACTIVITY_FORWARD_RESULT`
 ...
 ![flag_activity_forword_result](https://kimss1502.github.io/assets/images/flag_activity_forword_result.png)
...
### 3.13. `FLAG_ACTIVITY_REORDER_TO_FRONT`
 ...
 ![flag_activity_reorder_to_front](https://kimss1502.github.io/assets/images/flag_activity_reorder_to_front.png)
...
### 3.15. `FLAG_ACTIVITY_TASK_ON_HOME` (API 11)
 ...
 ![flag_activity_task_on_home](https://kimss1502.github.io/assets/images/flag_activity_task_on_home.png)
...
#### 3.16.2. 런처 홈 아이콘을 통해 앱을 실행 
 ...
 2. Action, Category 지정 <br/>
    ...
    ![launcher_app_intent](https://kimss1502.github.io/assets/images/launcher_app_intent.png)
...
#### 3.16.3. clearTaskOnLaunch 속성
 ...
 ![clearTaskOnLaunch](https://kimss1502.github.io/assets/images/clearTaskOnLaunch.png)
...
#### 3.16.4. finishOnTaskLaunch 속성
 ...
 ![finishOnTaskLaunch](https://kimss1502.github.io/assets/images/finishOnTaskLaunch.png)
...
![allowTaskReparenting](https://kimss1502.github.io/assets/images/allowTaskReparenting.png)
...
### 3.17. `FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET` (API 3, Deprecated)
 ...
 ![flag_activity_clear_when_task_reset](https://kimss1502.github.io/assets/images/flag_activity_clear_when_task_reset.png)
...
#### 4.3.1. 중요 특징
 ...
 ![singletask_feature](https://kimss1502.github.io/assets/images/singletask_feature.png)
...
> **[참고 문서]**
> 
> 1. [안드로이드 가이드](https://developer.android.com/guide/components/tasks-and-back-stack.html#IntentFlagsForTasks/) <br>
> 2. 도서 "이것이 안드로이드다" <br>